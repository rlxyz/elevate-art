...
You will land on the Upload page where you will be able to drop in the parent folder with your layer folders and trait images placed in the file structure below. In the example below you will need to upload the 'proof-moonbirds' folder.
