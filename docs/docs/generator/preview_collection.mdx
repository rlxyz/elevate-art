...
:::note
When you first Upload your Trait Artwork for the first time you may notice that the layers are out of order. To re-arrange your layers you need to first Reorder your Layers by heading to the [Rarity](./rarity) tab.
:::
