...
export const RepositorySettingNavigation = () => {
...
export const RepositoryGeneralSettings = () => {
        ...
        <div className='p-6 space-y-4'>
          <div className='flex flex-col'>
            <div className='col-span-6 font-plus-jakarta-sans space-y-2'>
              ...
              <p className='text-xs text-black'>{'Used to identify your projects name on elevate.art'}</p>
            </div>
          </div>
          <div className='w-full border border-mediumGrey rounded-[5px]'>
            <div className='h-full grid grid-cols-10 text-sm'>
              ...
              <div className='col-span-6 flex items-center'>
                ...
                /> */}
                <span className='text-xs px-2 w-full h-full items-center flex rounded-[5px]'>{repository?.name}</span>
              </div>
            </div>
          </div>
        </div>
