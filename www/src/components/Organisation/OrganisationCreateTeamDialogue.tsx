...
import { useMutateCreateTeam } from '@hooks/mutations/useMutateCreateTeam'
...
export const OrganisationCreateTeamDialog = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  const { notifySuccess, notifyError } = useNotification()
  const { mutate, isLoading } = useMutateCreateTeam()
  return (
    <>
