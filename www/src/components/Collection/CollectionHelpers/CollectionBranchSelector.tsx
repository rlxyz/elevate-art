...
const CreateCollectionDialog = ({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: Dispatch<SetStateAction<boolean>> }) => {
...
const Index = () => {
  ...
  return (
    <>
      ...
      <CreateCollectionDialog setIsOpen={setIsOpen} isOpen={isOpen} />
    </>
  )
}
