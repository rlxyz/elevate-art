...
export type LayoutContainerProps = Props & Omit<React.HTMLAttributes<any>, keyof Props>;
 ...
 * are independent.
 */
const LayoutContainerComponent: React.FC<React.PropsWithChildren<LayoutContainerProps>> = ({
  children,
  className,
  border,
  hasMargin,
  ...
  return (
    ...
    >
      <div className={clsx(hasMargin ? "h-full w-[90%] lg:w-[70%] 2xl:w-[75%] 3xl:w-[65%]" : "h-full w-full")}>
