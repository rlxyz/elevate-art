          ...
          return (
            <th
              className={clsx(
                !loading &&
                  index === 0 &&
                  "border-t border-l border-mediumGrey pl-3",
                !loading &&
...
const TableHeadRow = ({
  ...
  return (
    <div className="flex items-center space-x-1">
      <span className="text-[0.65rem] uppercase font-normal text-darkGrey">
        {title}
      </span>
      {description && (
        <Popover>
          <Popover.Button
            ...
            className="text-darkGrey w-3 h-3 bg-lightGray"
          />
          <Transition
            as={Fragment}
