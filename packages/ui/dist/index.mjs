...
var LayoutComponent = ({
  ...
  return /* @__PURE__ */ jsxs6("main", {
    ...
    children: [
      children,
      hasFooter ? /* @__PURE__ */ jsx12(layout_container_default, {
        border: "upper",
        className: "min-h-[3.5rem] flex items-center",
        children: /* @__PURE__ */ jsx12(layout_footer_default, {})
      }) : null
    ]
  });
};
...
var LayoutBodyItemComponent = ({
  ...
  return /* @__PURE__ */ jsx14(layout_container_default, {
    border,
    hasMargin,
    ...props,
