...
import { Rules, useQueryLayerElementFindAll } from "src/hooks/trpc/layerElement/useQueryLayerElementFindAll";
  ...
  return (
    <div className="text-darkGrey grid grid-cols-10 space-x-3">
      ...
      <div className="relative right-0 col-span-1 flex h-full items-center justify-center">
        <button className="bg-white disabled:bg-white disabled:text-mediumGrey flex w-full justify-center" onClick={() => setIsOpen(true)}>
