      ...
      <div className='w-full'>
        ...
        <div className='mx-auto max-w-5xl px-4 sm:px-6 lg:px-8'>
          <div className='-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5'>
            <div className='flex'>
              <AvatarComponent className='h-24 w-24 rounded-full ring-8 ring-white sm:h-32 sm:w-32' src='/images/avatar-blank.png' />
            </div>
          </div>
          ...
          <div className='py-6 text-darkGrey'>Australian based photographer showcasing otherworldly colours and textures.</div>
          <div className='flex space-x-4'>
            <div>
              <AvatarComponent variant='sm' className='ring-4 ring-white ' src='/images/avatar-blank.png' />
              <AvatarComponent variant='sm' className='ring-4 ring-white ' src='/images/avatar-blank.png' />
              <AvatarComponent variant='sm' className='ring-4 ring-white ' src='/images/avatar-blank.png' />
              <AvatarComponent variant='sm' className='ring-4 ring-white ' src='/images/avatar-blank.png' />
              <AvatarComponent variant='sm' className='ring-4 ring-white ' src='/images/avatar-blank.png' />
            </div>
            <div className='font-semibold'> 14 collectors</div>
          </div>
        </div>
      </div>
    </>
