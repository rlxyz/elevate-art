...
export const useMutateRepositoryUpdateHeight = () => {
  ...
  return trpc.repository.updateHeight.useMutation({
    onSuccess: (data) => {
      ctx.repository.findByName.setData({ repositoryName: r, organisationName: o }, (old) => {
        ...
        notifySuccess(`You have updated the height of the images in this project.`)
        return next
      })
    },
    onError: (err) => {
